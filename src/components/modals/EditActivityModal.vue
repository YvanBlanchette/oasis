...
<template>
  <Modal>
    ...
    <div class="w-full h-full flex flex-col items-center justify-center text-black">
      <!-- Modal Title -->
      <h1 class="text-4xl lg:text-5xl text-center font-semibold mb-6">Modifier une activité</h1>
      <!-- Form -->
      <form @submit.prevent="updateActivity(activityData.id)" class="flex flex-col w-full">
        <div class="flex gap-8 w-full justify-between">
          <div class="flex flex-col gap-2 justify-between w-full h-full">
            <!-- Name Input -->
            <Input type="text" label="Nom" v-model="formData.name" className="text-black w-full" />

            <!-- Description -->
            <TextArea label="Description" v-model="formData.description" className="text-black w-full" />
          </div>
        ...
        <div class="mt-3 w-full">
          <Input v-model="formData.ageRestriction" label="Restriction d'age" className="text-black w-full" />
        </div>
