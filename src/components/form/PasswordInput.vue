...
<template>
  <fieldset class="relative bg-transparent px-3 py-0.5 pb-1.5 border border-primary rounded-lg w-[90%] mx-auto" :class="className">
    ...
    <input novalidate autocomplete="current-password" :type="type" :placeholder="placeholder" :id="id" :name="name" v-model="inputValue" class="bg-transparent focus:outline-none focus:ring-0 focus:ring-offset-0 w-full h-full text-black pb-1 px-2 placeholder:text-neutral-400">
